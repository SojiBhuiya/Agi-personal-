...
val selfContainedSuites = listOf(
    "LocalRuleProviderTest", "OnlineProviderTest", "IntentRoutingTest", "SpeechInputTest", "LatencyTest", "RequestFlowTest", "GeminiSignatureTest", "SimpleSetupTest", "VolumeControlTest", "AgentLoopTest", "UpdateConnectivityTest", "UpdateCheckerTest", "ReleasePublishingTest", "UpdateUiPolicyTest",
