...
"$TOOLCHAIN/kotlinc/bin/kotlinc" -jvm-target 1.8 -no-reflect \
  ...
  "$ROOT/app/src/main/java/com/agi/assistant/core/tools/Tool.kt" "$ROOT/app/src/main/java/com/agi/assistant/core/tools/ToolResult.kt" "$ROOT/app/src/main/java/com/agi/assistant/core/tools/VolumeLogic.kt" "$ROOT/app/src/main/java/com/agi/assistant/core/agent/AgentLoop.kt" "$ROOT/app/src/main/java/com/agi/assistant/core/agent/Latency.kt" "$ROOT/app/src/main/java/com/agi/assistant/core/agent/IntentRouter.kt" "$ROOT/app/src/main/java/com/agi/assistant/core/tools/WeatherLogic.kt" \
