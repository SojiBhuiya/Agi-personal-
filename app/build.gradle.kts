...
val selfContainedSuites = listOf(
    "LocalRuleProviderTest", "OnlineProviderTest", "IntentRoutingTest", "LatencyTest", "RequestFlowTest", "GeminiSignatureTest", "SimpleSetupTest", "VolumeControlTest", "AgentLoopTest", "UpdateCheckerTest", "ReleasePublishingTest", "UpdateUiPolicyTest",
